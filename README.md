was able to get the live server to work before but now my code seems to be running in to some errors and will not open will be asking my Tutor for help on this but i will submit the home work to beable to not have it go down as a incomplet in the gradebook
